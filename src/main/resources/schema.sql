...
CREATE TABLE IF NOT EXISTS trade (
  ...
  CONSTRAINT trade_fk FOREIGN KEY (id_customer) REFERENCES customer (id) ON UPDATE CASCADE,
  CONSTRAINT trade_fk2 FOREIGN KEY (id_seller) REFERENCES seller (id) ON UPDATE CASCADE,
  CONSTRAINT trade_fk3 FOREIGN KEY (id_flat) REFERENCES flat (id) ON UPDATE CASCADE
);
